    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <img src={ImageLogo} alt="ForgePilot" className="size-16 rounded-xl" />
          <div>
            <h2 className="text-foreground text-xl font-bold">ForgePilot</h2>
        ...
        <button
          onClick={() =>
            openExternalUrl(
              'https://forgepilot.ai/download?utm_source=forgepilot_desktop'
            )
          }
      ...
      <div className="space-y-3">
        <div className="border-border flex items-center justify-between rounded-lg border p-3">
          ...
          <button
            onClick={() =>
              openExternalUrl('https://idoubi.ai?utm_source=forgepilot_desktop')
            }
        ...
        <div className="border-border flex items-center justify-between rounded-lg border p-3">
          ...
          <button
            onClick={() =>
              openExternalUrl('https://thinkany.ai?utm_source=forgepilot_desktop')
            }
            className="text-foreground hover:text-primary flex cursor-pointer items-center gap-1 text-sm font-medium transition-colors"
          >
            © 2026 ThinkAny
        ...
        <div className="border-border flex items-center justify-between rounded-lg border p-3">
          ...
          <button
            onClick={() =>
              openExternalUrl(
                'https://github.com/forgepilot-ai/forgepilot/blob/main/LICENSE'
              )
            }
            className="text-foreground hover:text-primary flex cursor-pointer items-center gap-1 text-sm font-medium transition-colors"
          >
            ForgePilot Community License
            <ExternalLink className="size-3" />
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        <button
          onClick={() =>
            openExternalUrl('https://forgepilot.ai?utm_source=forgepilot_desktop')
          }
        ...
        <button
          onClick={() =>
            openExternalUrl('https://github.com/forgepilot-ai/forgepilot')
          }
          className="border-border text-foreground hover:bg-accent flex cursor-pointer items-center gap-2 rounded-lg border px-4 py-2 text-sm transition-colors"
        >
        ...
        <button
          onClick={() => openExternalUrl('https://x.com/forgepilotai')}
          className="border-border text-foreground hover:bg-accent flex cursor-pointer items-center gap-2 rounded-lg border px-4 py-2 text-sm transition-colors"
        >
          <svg className="size-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          onClick={() =>
            openExternalUrl('https://github.com/forgepilot-ai/forgepilot/issues')
          }
          className="border-border text-foreground hover:bg-accent flex cursor-pointer items-center gap-2 rounded-lg border px-4 py-2 text-sm transition-colors"
        >
      ...
      <div className="border-border border-t pt-4">
        <button
          onClick={() =>
            openExternalUrl('https://shipany.ai?utm_source=forgepilot_desktop')
          }
