export default {
  ...
  skillsImportBranch: '分支',
  skillsImportBranchPlaceholder: '可选（例如 main）',
  skillsImportPath: '路径',
  skillsImportPathPlaceholder: '可选（例如 skills/my-skill）',
  skillsImportTargetUnavailable: 'Skills 目录不可用。',
  skillsImportFailed: '导入失败',
  skillsImportSelfCheck: '运行导入自检',
  skillsImportSelfCheckDesc: '验证 GitHub Skill 导入链路（网络 -> 克隆 -> SKILL.md 识别），不会写入你的 Skills 目录。',
  skillsImportSelfChecking: '自检中...',
  skillsImportSelfCheckSuccess: '自检通过（发现 {count} 个 Skill 路径）。',
  skillsImportSelfCheckFailed: '自检失败',
  skillsImport: '导入',
  skillsImporting: '导入中...',
