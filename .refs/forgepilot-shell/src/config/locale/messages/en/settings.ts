export default {
  ...
  skillsImportBranch: 'Branch',
  skillsImportBranchPlaceholder: 'optional (e.g. main)',
  skillsImportPath: 'Path',
  skillsImportPathPlaceholder: 'optional (e.g. skills/my-skill)',
  skillsImportTargetUnavailable: 'Skills directory is not available.',
  skillsImportFailed: 'Import failed',
  skillsImportSelfCheck: 'Run Import Self-Check',
  skillsImportSelfCheckDesc:
    'Validate GitHub skill import chain (network -> clone -> SKILL.md detection) without writing to your skills directory.',
  skillsImportSelfChecking: 'Checking...',
  skillsImportSelfCheckSuccess: 'Self-check passed ({count} skill path(s) found).',
  skillsImportSelfCheckFailed: 'Self-check failed',
  skillsImport: 'Import',
