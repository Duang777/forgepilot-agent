...
// MCP config file path: ~/.forgepilot/mcp.json
const getMcpConfigPath = (): string => {
  const homeDir = os.homedir();
  return path.join(homeDir, '.forgepilot', 'mcp.json');
};
...
// GET /mcp/all-configs - Read MCP configs from all sources (forgepilot and claude)
