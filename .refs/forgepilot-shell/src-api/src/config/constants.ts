 ...
 *
 * Centralized configuration constants for the ForgePilot API.
...
export const APP_DIR_NAME = '.forgepilot';
...
export const CONFIG_SEARCH_PATHS = [
  './forgepilot.config.json',
  './config/forgepilot.json',
];
...
/** Get ForgePilot app data directory */
...
/** Get ForgePilot skills directory */
export function getForgepilotSkillsDir(): string {
...
export function getAllSkillsDirs(): { name: string; path: string }[] {
  return [
    { name: 'forgepilot', path: getForgepilotSkillsDir() },
    { name: 'claude', path: getClaudeSkillsDir() },
  ];
}

/** Get ForgePilot MCP config path */
export function getForgepilotMcpConfigPath(): string {
...
export function getAllMcpConfigPaths(): { name: string; path: string }[] {
  return [
    { name: 'forgepilot', path: getForgepilotMcpConfigPath() },
