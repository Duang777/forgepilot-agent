...
Thank you for your interest in the ForgePilot project! We welcome all forms of contributions, including but not limited to:
...
1. Search [Issues](https://github.com/forgepilot-ai/forgepilot/issues) to check if a similar issue already exists
...
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/forgepilot-ai/forgepilot.git
   ```
...
1. Your contributions will be licensed under the [ForgePilot Community License](LICENSE)
...
- GitHub Issues: [github.com/forgepilot-ai/forgepilot/issues](https://github.com/forgepilot-ai/forgepilot/issues)
- Email: hello@forgepilot.ai
