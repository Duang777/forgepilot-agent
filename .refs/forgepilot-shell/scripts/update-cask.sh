...
CASK_FILE="$PROJECT_ROOT/Casks/forgepilot.rb"

GITHUB_REPO="forgepilot-ai/forgepilot"
...
# Download URLs
ARM_URL="https://github.com/${GITHUB_REPO}/releases/download/v${VERSION}/ForgePilot_${VERSION}_aarch64.dmg"
INTEL_URL="https://github.com/${GITHUB_REPO}/releases/download/v${VERSION}/ForgePilot_${VERSION}_x64.dmg"
...
echo ""
echo "Next steps:"
echo "  git add Casks/forgepilot.rb"
echo "  git commit -m \"chore: update forgepilot to v$VERSION\""
echo "  git push"
